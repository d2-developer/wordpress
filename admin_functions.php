		...
		<div class='mv_metabox_main'>
			<div class='form_main'>
				...
				<div class='form_fields'>
					...
					<input type='checkbox' name='autoship_product_mvprod' value='1' <?php  if(get_post_meta($post_id,"autoship_product_mvprod",true)==true){ echo "checked='checked'"; } ?> />
				</div>
				<div class='form_fields'>
					<label>Promoter Pack : </label>
					<input type='checkbox' name='cs_mv_promoterpack' value='yes'<?php  if(get_post_meta($post_id,"cs_mv_promoterpack",true)=='yes'){ echo "checked='checked'"; } ?> />
				</div>
				<div class='form_fields'>
					<label>Promoter Membership Product : </label>
					<input type='checkbox' name='cs_mv_promotermembershipproduct' value='yes'<?php  if(get_post_meta($post_id,"cs_mv_promotermembershipproduct",true)=='yes'){ echo "checked='checked'"; } ?> />
				</div>
				<div class='form_fields'>
					<label>Promoter Renewal Product : </label>
					<input type='checkbox' name='cs_mv_promoterproduct' value='yes'<?php  if(get_post_meta($post_id,"cs_mv_promoterproduct",true)=='yes'){ echo "checked='checked'"; } ?> />
				</div>
				<div class='form_fields'>
					<label>Need Promoter Renewal Product for Checkout? : </label>
					<input type='checkbox' name='cs_mv_need_promoterproduct' value='yes'<?php  if(get_post_meta($post_id,"cs_mv_need_promoterproduct",true)=='yes'){ echo "checked='checked'"; } ?> />
				</div>
				<?php
				...
				<div class='form_fields mvradioboxes'>
					...
					<?php if(get_option('cs_mv_countrysupport') != "") {  
						...
						<div class="container"> <?php echo $countrysupport; ?>
							<input type='radio' name='cs_mv_country' value='<?php echo $countrysupport;  ?>' <?php if(get_post_meta($post_id,"cs_mv_country",true) == "$countrysupport") { echo "checked";  } ?> /> 
				...
				<div class='form_fields'>
					...
					<input type='checkbox' name='cs_product_of_month' value='yes' <?php  if(get_post_meta($post_id,"cs_product_of_month",true)=='yes'){ echo "checked='checked'"; } ?> />
				</div>
